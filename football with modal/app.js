...
var divmain = document.getElementById("teamlist");
var heading = document.createElement('h1');
divmain.appendChild(heading);
// var heading = document.c();
var allRounds = data.rounds;

var div1 = document.createElement('div');
div1.setAttribute("id", "contanier")

divmain.appendChild(div1)
for (var key in allRounds) {
    // console.log(allRounds[key]);
    var box = document.createElement('div');
    box.setAttribute("id", "name-box");
    box.appendChild(document.createTextNode(allRounds[key].name));
    box.setAttribute("onClick", `showData(${key})`)
...
function showData(x) {
    ...
    displayInfo.setAttribute("id", "dataBox");

    popup.appendChild(displayInfo);

    // modal.appendChild(displayInfo);
    for (var key2 in allRounds[x].matches) {
        console.log(allRounds[x].matches[key2]);
        var p = document.createElement('p');
        var span = document.createElement('span');

        span.appendChild(document.createTextNode(allRounds[x].matches[key2].date));

        p.appendChild(span);

        var span = document.createElement('span');

        span.appendChild(document.createTextNode(allRounds[x].matches[key2].team1));
        ...
        span.appendChild(document.createTextNode(allRounds[x].matches[key2].team2));
        ...
        span.appendChild(document.createTextNode(allRounds[x].matches[key2].score));
        ...
        span.appendChild(document.createTextNode(allRounds[x].matches[key2].ft));
